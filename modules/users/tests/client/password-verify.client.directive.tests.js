...
(function() {
  ...
  describe('PasswordVerifyDirective', function() {
    ...
    function compileDirective(template) {
      ...
      if (!template) template = '<input type="password" id="newPassword" name="newPassword" class="form-control" ng-model="passwordMock.newPassword" placeholder="Nowe Hasło" autocomplete="new-password" uib-popover="{{getPopoverMsg}}" uib-popover-trigger="focus" uib-popover-placement="top" password-validator required>' +
        '<input type="password" id="verifyPassword" name="verifyPassword" class="form-control" ng-model="passwordMock.verifyPassword" placeholder="Powtóz nowe Hasło" password-verify="passwordMock.newPassword" required>';
