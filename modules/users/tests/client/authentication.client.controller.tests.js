    ...
    describe('Logged out user', function () {
      ...
      describe('$scope.signup()', function () {
        ...
        it('should fail to register with duplicate Username', function () {
          ...
          // Test Notification.error is called
          expect(Notification.error).toHaveBeenCalledWith({ message: 'Nazwa użytkownika jest zajęta', title: '<i class="glyphicon glyphicon-remove"></i> Rejestracja nieudana', delay: 6000 });
        });
      });
    });
