(function () {
  ...
  function ChangePasswordController($scope, $http, Authentication, UsersService, PasswordValidator, Notification) {
    ...
    function onChangePasswordSuccess(response) {
      ...
      Notification.success({ message: '<i class="glyphicon glyphicon-ok"></i> Hasło zostało zmienione' });
      vm.passwordDetails = null;
    }

    function onChangePasswordError(response) {
      Notification.error({ message: response.data.message, title: '<i class="glyphicon glyphicon-remove"></i> Hasło NIE zostało zmienione' });
    }
  }
}());
