    ...
    describe('Route Config', function () {
      ...
      describe('List Route', function () {
        ...
        it('Should have templateUrl', function () {
          expect(liststate.templateUrl).toBe('/modules/articles/client/views/admin/list-lectures.client.view.html');
        });
      });
      ...
      describe('Create Route', function () {
        ...
        beforeEach(inject(function ($controller, $state, $templateCache) {
          ...
          $templateCache.put('/modules/articles/client/views/admin/form-lecture.client.view.html', '');
        ...
        it('Should have templateUrl', function () {
          expect(createstate.templateUrl).toBe('/modules/articles/client/views/admin/form-lecture.client.view.html');
        });
      });
      ...
      describe('Edit Route', function () {
        ...
        it('Should have templateUrl', function () {
          expect(editstate.templateUrl).toBe('/modules/articles/client/views/admin/form-lecture.client.view.html');
        });
