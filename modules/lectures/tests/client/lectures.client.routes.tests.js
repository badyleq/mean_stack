    ...
    describe('Route Config', function () {
      ...
      describe('List Route', function () {
        ...
        it('Should have templateUrl', function () {
          expect(liststate.templateUrl).toBe('/modules/articles/client/views/list-lectures.client.view.html');
        });
      });
      ...
      describe('View Route', function () {
        ...
        beforeEach(inject(function ($controller, $state, $templateCache) {
          ...
          $templateCache.put('/modules/articles/client/views/view-lecture.client.view.html', '');
        ...
        it('Should have templateUrl', function () {
          expect(viewstate.templateUrl).toBe('/modules/articles/client/views/view-lecture.client.view.html');
        });
      });

      describe('Handle Trailing Slash', function () {
        beforeEach(inject(function ($state, $rootScope, $templateCache) {
          $templateCache.put('/modules/articles/client/views/list-lectures.client.view.html', '');
        ...
        it('Should remove trailing slash', inject(function ($state, $location, $rootScope) {
          ...
          expect($state.current.templateUrl).toBe('/modules/articles/client/views/list-lectures.client.view.html');
        }));
      });
    });
  });
